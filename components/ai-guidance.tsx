...
export function AIGuidance({ drawingMetrics }: AIGuidanceProps) {
  ...
  const suggestions = [
    ...
    "Нарисуй что-то круглое. Круглые формы активируют центры удовольствия в мозге.",
    "Добавь немного синего цвета. Синий помогает успокоиться и сосредоточиться.",
      ...
      <Card className="bg-gradient-to-r from-blue-100 to-blue-200 border-blue-300">
        <CardContent className="pt-6">
          <div className="flex items-start gap-3">
            ...
            <p className="italic text-blue-900 font-medium">{currentSuggestion}</p>
          </div>
        </CardContent>
      </Card>

      <div className="space-y-2">
        <h3 className="text-sm font-medium text-blue-900">Предыдущие подсказки:</h3>
