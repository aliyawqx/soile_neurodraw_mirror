  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-purple-50 to-purple-100">
      <header className="px-4 lg:px-6 h-16 flex items-center border-b bg-white/80 backdrop-blur-sm">
        ...
        <span className="text-xl font-bold text-purple-800">Sana - Мой прогресс</span>
      </header>
      ...
      <main className="flex-1 p-4 md:p-6 space-y-6">
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-purple-200">
          <CardHeader>
            ...
            <CardDescription className="text-purple-700">Твои сохраненные нейрорисунки и их анализ</CardDescription>
          </CardHeader>
          <CardContent>
